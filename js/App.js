class App extends React.Component {
   ...
   */
  renderVideo = async () => {
    const { model, ctx, videoRef, canvasRef, backgroundRef, offCtx, offCanvas } = this;
  ...
  render() {
    ...
    const { modelReady, height, width, backgroundMode, backgroundSrc } = this.state;
          ...
          <div className="container-fluid">
            <div className="row">
              <div className="background col-sm">
                {backgroundMode === "image" ? (
                  <img src={backgroundSrc} alt="background" height={height} width={width} ref={backgroundRef} />
                ) : (
                  <video playsinline autoplay loop muted src={backgroundSrc} height={height} width={width} ref={backgroundRef}></video>
                )}
                <input type="file" onChange={handleFileChange} />
              </div>
              <div className="webcam-source col-sm">
                <video playsinline ref={videoRef} height={height} width={width}></video>
              </div>
            </div>
            <div className="row">
